...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 7742)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for JSON-RPC connections on <port> (default: 7743)"),
