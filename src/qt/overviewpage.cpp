...
void OverviewPage::refreshEstimatedStakeTime()
{
    ...
    {
        this->ui->labelEstimatedStakeTime->setText(tr("Not minting") + " <sup><a href='https://github.com/NeuCoin/neucoin/blob/master/doc/faq.md#why-isnt-my-client-minting'>" + tr("(why?)") + "</a></sup>");
    }
